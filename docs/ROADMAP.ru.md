...
Отдельное отслеживание вручную одобренных групп:
- Сохранение ID админа, который одобрил группу
- Инвалидация только если одобривший админ покинул группу (не если потерял права)
- 24ч grace period когда одобривший уходит, с уведомлением
- Ежемесячный review с кнопками [Оставить]/[Отозвать]
- `/allowed_groups` команда для просмотра и отзыва доступов
- См. [docs/designs/2026-01-28-manual-group-approvals.md](designs/2026-01-28-manual-group-approvals.md)
