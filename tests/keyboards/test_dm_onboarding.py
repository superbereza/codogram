...
def test_carousel_keyboard_first_slide():
    ...
    from codogram.telegram.keyboards.dm_onboarding import carousel_keyboard
...
def test_validation_recheck_keyboard():
    ...
    from codogram.telegram.keyboards.dm_onboarding import validation_recheck_keyboard
...
def test_dashboard_keyboard():
    ...
    from codogram.telegram.keyboards.dm_onboarding import dashboard_keyboard
